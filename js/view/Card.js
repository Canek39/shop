    ...
    getHtml() {
        return `<div class="product_card">
                    <div class="product_img_block">
                        ...
                        <img class="img_product" src="img/${this._data.image}" alt=""image>


                    </div>
                    <div class="info_product">
                        <a class="heading_product_link" href="product.html">
                            <h3 class="heading_product">${this._data.title}</h3>
                        </a>
                        <p class="desc_product">${this._data.description}</p>
                        <p class="price_product">$${this._data.getPrice()}</p>
                    </div>
